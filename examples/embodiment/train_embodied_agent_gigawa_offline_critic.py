...
def main(cfg) -> None:
    ...
    for epoch in range(1, max_epochs + 1):
        metrics = _pick_group_metrics(actor_group.run_offline_critic_epoch().wait())
        global_step += 1
        ...
        print(
            ...
            f"train_loss={train_loss:.8f} | val_loss={val_loss:.8f} | gap={gap:.8f} | "
        ...
        print(
            ...
            f"train_success_q={metrics.get('offline_critic/train_success/q_logged_mean', 0.0):.8f} | "
            f"train_failure_q={metrics.get('offline_critic/train_failure/q_logged_mean', 0.0):.8f} | "
            f"val_success_q={metrics.get('offline_critic/val_success/q_logged_mean', 0.0):.8f} | "
            f"val_failure_q={metrics.get('offline_critic/val_failure/q_logged_mean', 0.0):.8f}"
        )
