...
train
cd /shared_disk/users/angen.ye/code/world_module_rollout/RLinf/examples/embodiment
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_embodied_agent_gigawa.py   --config-path ./config   --config-name robotwin_place_empty_cup_eval_giga_world_policy_train   ++actor.fsdp_config.use_orig_params=true